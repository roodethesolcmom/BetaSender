...
class Texts():
    startmessage = 'Чем могу быть полезен?'
    welcomemes = 'Привет, {firstname}! Я помогу тебе рассказать всем о своем продукте)'
    ...
    sendinstuct = '📨Остаток сообщений: {mescount}\n\n💬Для создания рассылки:\n\n' \
                  ...
                  '3. Запускай✅'
    profiletext = 'Ваш ID: {chat_id}\nНик: {username}\nКол-во сообщений: {mescount}\n' \
    ...
    partertext = 'Приведено рефералов: {refcount}\nПривели твои рефералы: {subrefcount}\n' \
                 ...
                 'Здесь ты можешь стать нашим партнером. Приводи знакомых - уводи врагов'
    channel_invite_af = 'Для пользования функционалом бота ты должен\n\n ❌ Подписаться на канал\n\n' \
                     '❌ Поделиться контактом\n\n' \
                        '✅ Продать свою мать'
    channel_invite_st = 'Для пользования функционалом бота ты должен\n\n ✅ Подписаться на канал\n\n' \
                                '❌ Поделиться контактом\n\n' \
                                '✅ Продать свою мать'
    channel_invite_ct = 'Для пользования функционалом бота ты должен\n\n ❌ Подписаться на канал\n\n' \
                        '✅ Поделиться контактом\n\n' \
                        '✅ Продать свою мать'
    phone_accept = 'Контакты обновлены успешно'
    ...
    bad_contact = 'Это не твой контакт, попробуй ещё'


class Links():
    feedbacklink = 'https://t.me/+5nxj8AINWBtlMTUy'
    supportlink = 'http://t.me/TeleTargetSupportRobot'
    channel_id = '@TelegProject'
    channel_url = 'https://t.me/TelegProject'